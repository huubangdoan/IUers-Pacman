...
/*  Ném cái này vào trong class để test chạy thử taij tachs branch neen khoong cos cais chayj ddeer test
    public static void main(String[] args) {
        JFrame testFrame = new JFrame("Test Màn Hình Settings");
        testFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        testFrame.setSize(672, 672);
        testFrame.setLocationRelativeTo(null);

        SettingsController dummyController = new SettingsController(null, null);
        
        testFrame.add(new SettingsPanel(dummyController));
